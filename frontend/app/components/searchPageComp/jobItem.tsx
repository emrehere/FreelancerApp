    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className="bg-orange-50 bg-opacity-50 hover:bg-orange-100 hover:bg-opacity-60 shadow-sm shadow-orange-300
             flex flex-col items-center justify-center sm:m-4 sm:w-[70vw] w-[90vw] mx-auto mb-2 sm:h-[45vh] h-[40rem] p-4 rounded-xl">
                
               <div className="-mt-2">
                    <p className="text-[14px] te">  2 minute ago </p>
