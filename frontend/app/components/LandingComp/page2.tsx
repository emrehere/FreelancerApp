...
function Page2() {
    ...
    return (
        <div>
            ...
            <div className='bg-[#0A0F26] sm:h-[35rem] h-[55rem] w-[96vw] mx-auto text-blue-50
             flex sm:flex-row flex-col rounded-xl mt-[1rem] sm:mt-0'>
                ...
                <div className='sm:block hidden  rounded-r-xl'>
                    <Image width={300} height={300} className='sm:w-[48vw] object-cover h-full rounded-r-xl' src="/kadin.webp" alt="kadin" />
                </div>
            </div>
            <br />
        </div>
