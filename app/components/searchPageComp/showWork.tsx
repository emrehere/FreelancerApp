    ...
    return (
        <div>
         ...
         bg-gray-700 bg-opacity-70 overflow-y-auto space-y-8'>
                ...
                <div className=' w-[70vw] bg-blue-50 overflow-y-auto h-screen 
